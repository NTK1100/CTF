...
public class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    public void initialize() {
        int drawableResId;
        float popupCornerRadius = this.context.getResources().getDimensionPixelOffset(C0593R.dimen.mtrl_shape_corner_size_small_component);
        float exposedDropdownPopupElevation = this.context.getResources().getDimensionPixelOffset(C0593R.dimen.mtrl_exposed_dropdown_menu_popup_elevation);
        int exposedDropdownPopupVerticalPadding = this.context.getResources().getDimensionPixelOffset(C0593R.dimen.mtrl_exposed_dropdown_menu_popup_vertical_padding);
        ...
        if (this.customEndIcon == 0) {
            drawableResId = IS_LOLLIPOP ? C0593R.C0595drawable.mtrl_dropdown_arrow : C0593R.C0595drawable.mtrl_ic_arrow_drop_down;
        } else {
            drawableResId = this.customEndIcon;
        }
        this.textInputLayout.setEndIconDrawable(drawableResId);
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C0593R.string.exposed_dropdown_menu_content_description));
    ...
    public void addRippleEffect(AutoCompleteTextView editText) {
        ...
        int rippleColor = MaterialColors.getColor(editText, C0593R.attr.colorControlHighlight);
    ...
    private void addRippleEffectOnOutlinedLayout(AutoCompleteTextView editText, int rippleColor, int[][] states, MaterialShapeDrawable boxBackground) {
        ...
        int surfaceColor = MaterialColors.getColor(editText, C0593R.attr.colorSurface);
    ...
    public void setUpDropdownShowHideBehavior(final AutoCompleteTextView editText) {
        editText.setOnTouchListener(new View.OnTouchListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate.8
        ...
        if (IS_LOLLIPOP) {
            editText.setOnDismissListener(new AutoCompleteTextView.OnDismissListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate.9
    ...
    private ValueAnimator getAlphaAnimator(int duration, float... values) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate.11
