...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public AppCompatSpinner(Context context, int mode) {
        this(context, null, C0021R.attr.spinnerStyle, mode);
    }

    public AppCompatSpinner(Context context, AttributeSet attrs) {
        this(context, attrs, C0021R.attr.spinnerStyle);
    }
    ...
    */
    public AppCompatSpinner(android.content.Context r7, android.util.AttributeSet r8, int r9, int r10, android.content.res.Resources.Theme r11) {
        /*
            ...
            goto L3b
        L29:
            int r2 = androidx.appcompat.C0021R.styleable.Spinner_popupTheme
        ...
        La6:
            ...
            r1.<init>()
            r6.mPopup = r1
            int r2 = androidx.appcompat.C0021R.styleable.Spinner_android_prompt
            java.lang.String r2 = r0.getString(r2)
            r1.setPromptText(r2)
        Lb7:
            int r1 = androidx.appcompat.C0021R.styleable.Spinner_android_entries
            java.lang.CharSequence[] r1 = r0.getTextArray(r1)
            if (r1 == 0) goto Lcf
            android.widget.ArrayAdapter r2 = new android.widget.ArrayAdapter
            r3 = 17367048(0x1090008, float:2.5162948E-38)
            r2.<init>(r7, r3, r1)
            int r3 = androidx.appcompat.C0021R.layout.support_simple_spinner_dropdown_item
