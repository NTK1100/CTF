...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    protected void onFinishInflate() {
        ...
        this.messageView = (TextView) findViewById(C0593R.C0596id.snackbar_text);
        this.actionView = (Button) findViewById(C0593R.C0596id.snackbar_action);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int multiLineVPadding = getResources().getDimensionPixelSize(C0593R.dimen.design_snackbar_padding_vertical_2lines);
        int singleLineVPadding = getResources().getDimensionPixelSize(C0593R.dimen.design_snackbar_padding_vertical);
