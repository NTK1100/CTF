...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable, MaterialCheckable<Chip> {
    ...
    private static final int DEF_STYLE_RES = C0593R.style.Widget_MaterialComponents_Chip_Action;
    ...
    public Chip(Context context, AttributeSet attrs) {
        this(context, attrs, C0593R.attr.chipStyle);
    }
    ...
    */
    public Chip(android.content.Context r8, android.util.AttributeSet r9, int r10) {
        /*
            ...
            r6.setElevation(r0)
            int[] r2 = com.google.android.material.C0593R.styleable.Chip
            r0 = 0
            int[] r5 = new int[r0]
            r0 = r8
            r1 = r9
            ...
            r2 = 23
            if (r1 >= r2) goto L52
            int r1 = com.google.android.material.C0593R.styleable.Chip_android_textColor
            android.content.res.ColorStateList r1 = com.google.android.material.resources.MaterialResources.getColorStateList(r8, r0, r1)
            r7.setTextColor(r1)
        L52:
            int r1 = com.google.android.material.C0593R.styleable.Chip_shapeAppearance
    ...
    private void initMinTouchTarget(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0593R.styleable.Chip, defStyleAttr, DEF_STYLE_RES, new int[0]);
        this.ensureMinTouchTargetSize = a.getBoolean(C0593R.styleable.Chip_ensureMinTouchTargetSize, false);
        float defaultMinTouchTargetSize = (float) Math.ceil(ViewUtils.dpToPx(getContext(), 48));
        this.minTouchTargetSize = (int) Math.ceil(a.getDimension(C0593R.styleable.Chip_chipMinTouchTargetSize, defaultMinTouchTargetSize));
        a.recycle();
    }
        ...
        protected void onPopulateNodeForVirtualView(int virtualViewId, AccessibilityNodeInfoCompat node) {
            if (virtualViewId == 1) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    int i = C0593R.string.mtrl_chip_close_icon_content_description;
