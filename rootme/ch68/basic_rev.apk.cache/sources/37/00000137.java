...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView, AbsListView.SelectionBoundsAdjuster {
    ...
    public ListMenuItemView(Context context, AttributeSet attrs) {
        this(context, attrs, C0021R.attr.listMenuViewStyle);
    }

    public ListMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs, C0021R.styleable.MenuView, defStyleAttr, 0);
        this.mBackground = a.getDrawable(C0021R.styleable.MenuView_android_itemBackground);
        this.mTextAppearance = a.getResourceId(C0021R.styleable.MenuView_android_itemTextAppearance, -1);
        this.mPreserveIconSpacing = a.getBoolean(C0021R.styleable.MenuView_preserveIconSpacing, false);
        this.mTextAppearanceContext = context;
        this.mSubMenuArrow = a.getDrawable(C0021R.styleable.MenuView_subMenuArrow);
        TypedArray b = context.getTheme().obtainStyledAttributes(null, new int[]{16843049}, C0021R.attr.dropDownListViewStyle, 0);
    ...
    private void insertIconView() {
        ...
        ImageView imageView = (ImageView) inflater.inflate(C0021R.layout.abc_list_menu_item_icon, (ViewGroup) this, false);
    ...
    private void insertRadioButton() {
        LayoutInflater inflater = getInflater();
        RadioButton radioButton = (RadioButton) inflater.inflate(C0021R.layout.abc_list_menu_item_radio, (ViewGroup) this, false);
    ...
    private void insertCheckBox() {
        LayoutInflater inflater = getInflater();
        CheckBox checkBox = (CheckBox) inflater.inflate(C0021R.layout.abc_list_menu_item_checkbox, (ViewGroup) this, false);
