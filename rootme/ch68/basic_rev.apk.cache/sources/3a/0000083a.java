...
public abstract class SpecialEffectsController {
    ...
    public static SpecialEffectsController getOrCreateController(ViewGroup container, SpecialEffectsControllerFactory factory) {
        Object controller = container.getTag(C0316R.C0319id.special_effects_controller_view_tag);
        ...
        container.setTag(C0316R.C0319id.special_effects_controller_view_tag, newController);
    ...
    public static class Operation {
        ...
        public enum State {
            ...
            public void applyState(View view) {
                switch (C03913.f91xe493b431[ordinal()]) {
                    case 1:
        ...
        final void mergeWith(State finalState, LifecycleImpact lifecycleImpact) {
            switch (C03913.f90xb9e640f0[lifecycleImpact.ordinal()]) {
                case 1:
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C03913 {
