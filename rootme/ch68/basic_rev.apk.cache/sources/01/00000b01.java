...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    private static final int DEF_STYLE_RES = C0593R.style.Widget_Design_AppBarLayout;
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        this(context, attrs, C0593R.attr.appBarLayoutStyle);
    }
    ...
    */
    public AppBarLayout(android.content.Context r10, android.util.AttributeSet r11, int r12) {
        ...
        L36:
            int[] r2 = com.google.android.material.C0593R.styleable.AppBarLayout
            int[] r5 = new int[r7]
            r0 = r10
            r1 = r11
            r3 = r12
            android.content.res.TypedArray r0 = com.google.android.material.internal.ThemeEnforcement.obtainStyledAttributes(r0, r1, r2, r3, r4, r5)
            int r1 = com.google.android.material.C0593R.styleable.AppBarLayout_android_background
        ...
        L6e:
            int r1 = com.google.android.material.C0593R.styleable.AppBarLayout_expanded
        ...
        L7f:
            ...
            if (r1 < r8) goto L95
            int r1 = com.google.android.material.C0593R.styleable.AppBarLayout_elevation
            boolean r1 = r0.hasValue(r1)
            if (r1 == 0) goto L95
            int r1 = com.google.android.material.C0593R.styleable.AppBarLayout_elevation
        ...
        L95:
            ...
            r2 = 26
            if (r1 < r2) goto Lbd
            int r1 = com.google.android.material.C0593R.styleable.AppBarLayout_android_keyboardNavigationCluster
            boolean r1 = r0.hasValue(r1)
            if (r1 == 0) goto Lac
            int r1 = com.google.android.material.C0593R.styleable.AppBarLayout_android_keyboardNavigationCluster
            boolean r1 = r0.getBoolean(r1, r7)
        ...
        Lac:
            int r1 = com.google.android.material.C0593R.styleable.AppBarLayout_android_touchscreenBlocksFocus
            boolean r1 = r0.hasValue(r1)
            if (r1 == 0) goto Lbd
            int r1 = com.google.android.material.C0593R.styleable.AppBarLayout_android_touchscreenBlocksFocus
            boolean r1 = r0.getBoolean(r1, r7)
        ...
        Lbd:
            int r1 = com.google.android.material.C0593R.styleable.AppBarLayout_liftOnScroll
            boolean r1 = r0.getBoolean(r1, r7)
            r9.liftOnScroll = r1
            int r1 = com.google.android.material.C0593R.styleable.AppBarLayout_liftOnScrollTargetViewId
            int r1 = r0.getResourceId(r1, r6)
            r9.liftOnScrollTargetViewId = r1
            int r1 = com.google.android.material.C0593R.styleable.AppBarLayout_statusBarForeground
            android.graphics.drawable.Drawable r1 = r0.getDrawable(r1)
    ...
    protected int[] onCreateDrawableState(int extraSpace) {
        ...
        extraStates[0] = this.liftable ? C0593R.attr.state_liftable : -C0593R.attr.state_liftable;
        extraStates[1] = (this.liftable && this.lifted) ? C0593R.attr.state_lifted : -C0593R.attr.state_lifted;
        extraStates[2] = this.liftable ? C0593R.attr.state_collapsible : -C0593R.attr.state_collapsible;
        extraStates[3] = (this.liftable && this.lifted) ? C0593R.attr.state_collapsed : -C0593R.attr.state_collapsed;
    ...
    private void startLiftOnScrollElevationOverlayAnimation(final MaterialShapeDrawable background, boolean lifted) {
        float appBarElevation = getResources().getDimension(C0593R.dimen.design_appbar_elevation);
        ...
        ofFloat.setDuration(getResources().getInteger(C0593R.integer.app_bar_elevation_anim_duration));
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            this.scrollFlags = 1;
            TypedArray a = c.obtainStyledAttributes(attrs, C0593R.styleable.AppBarLayout_Layout);
            this.scrollFlags = a.getInt(C0593R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            int scrollEffectInt = a.getInt(C0593R.styleable.AppBarLayout_Layout_layout_scrollEffect, 0);
            setScrollEffect(createScrollEffectFromInt(scrollEffectInt));
            if (a.hasValue(C0593R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                int resId = a.getResourceId(C0593R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0);
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0593R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(a.getDimensionPixelSize(C0593R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            a.recycle();
        }
