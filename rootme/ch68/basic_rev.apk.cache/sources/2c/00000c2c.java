...
public class FloatingActionButtonImpl {
    ...
    private AnimatorSet createDefaultAnimator(final float targetOpacity, final float targetScale, final float targetIconScale) {
        ...
        AnimatorSetCompat.playTogether(set, animators);
        set.setDuration(MotionUtils.resolveThemeDuration(this.view.getContext(), C0593R.attr.motionDurationLong1, this.view.getContext().getResources().getInteger(C0593R.integer.material_motion_duration_long_1)));
        set.setInterpolator(MotionUtils.resolveThemeInterpolator(this.view.getContext(), C0593R.attr.motionEasingStandard, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
        return set;
    }
