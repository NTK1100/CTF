...
public class MaterialAutoCompleteTextView extends AppCompatAutoCompleteTextView {
    ...
    public MaterialAutoCompleteTextView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0593R.attr.autoCompleteTextViewStyle);
    }
    ...
    public MaterialAutoCompleteTextView(Context context, AttributeSet attributeSet, int defStyleAttr) {
        ...
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C0593R.styleable.MaterialAutoCompleteTextView, defStyleAttr, C0593R.style.Widget_AppCompat_AutoCompleteTextView, new int[0]);
        if (attributes.hasValue(C0593R.styleable.MaterialAutoCompleteTextView_android_inputType)) {
            int inputType = attributes.getInt(C0593R.styleable.MaterialAutoCompleteTextView_android_inputType, 0);
            if (inputType == 0) {
                setKeyListener(null);
            }
        }
        int inputType2 = C0593R.styleable.MaterialAutoCompleteTextView_simpleItemLayout;
        this.simpleItemLayout = attributes.getResourceId(inputType2, C0593R.layout.mtrl_auto_complete_simple_item);
        ...
        if (attributes.hasValue(C0593R.styleable.MaterialAutoCompleteTextView_simpleItems)) {
            setSimpleItems(attributes.getResourceId(C0593R.styleable.MaterialAutoCompleteTextView_simpleItems, 0));
        }
        attributes.recycle();
    }
