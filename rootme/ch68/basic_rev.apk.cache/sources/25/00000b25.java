...
public final class BadgeState {
    ...
    public BadgeState(Context context, int badgeResId, int defStyleAttr, int defStyleRes, State storedState) {
        ...
        this.badgeRadius = a.getDimensionPixelSize(C0593R.styleable.Badge_badgeRadius, res.getDimensionPixelSize(C0593R.dimen.mtrl_badge_radius));
        this.badgeWidePadding = a.getDimensionPixelSize(C0593R.styleable.Badge_badgeWidePadding, res.getDimensionPixelSize(C0593R.dimen.mtrl_badge_long_text_horizontal_padding));
        this.badgeWithTextRadius = a.getDimensionPixelSize(C0593R.styleable.Badge_badgeWithTextRadius, res.getDimensionPixelSize(C0593R.dimen.mtrl_badge_with_text_radius));
        state.alpha = storedState.alpha == -2 ? 255 : storedState.alpha;
        if (storedState.contentDescriptionNumberless == null) {
            charSequence = context.getString(C0593R.string.mtrl_badge_numberless_content_description);
        } else {
        ...
        if (storedState.contentDescriptionQuantityStrings == 0) {
            i = C0593R.plurals.mtrl_badge_content_description;
        } else {
        ...
        if (storedState.contentDescriptionExceedsMaxBadgeNumberRes == 0) {
            i2 = C0593R.string.mtrl_exceed_max_badge_number_content_description;
        } else {
        ...
        if (storedState.maxCharacterCount == -2) {
            i3 = a.getInt(C0593R.styleable.Badge_maxCharacterCount, 4);
        } else {
            i3 = storedState.maxCharacterCount;
        }
        state.maxCharacterCount = i3;
        if (storedState.number == -2) {
            if (a.hasValue(C0593R.styleable.Badge_number)) {
                state.number = a.getInt(C0593R.styleable.Badge_number, 0);
            } else {
                state.number = -1;
            }
        } else {
        ...
        if (storedState.backgroundColor == null) {
            intValue = readColorFromAttributes(context, a, C0593R.styleable.Badge_backgroundColor);
        } else {
        ...
        if (storedState.badgeTextColor == null) {
            if (!a.hasValue(C0593R.styleable.Badge_badgeTextColor)) {
                TextAppearance textAppearance = new TextAppearance(context, C0593R.style.TextAppearance_MaterialComponents_Badge);
                state.badgeTextColor = Integer.valueOf(textAppearance.getTextColor().getDefaultColor());
            } else {
                state.badgeTextColor = Integer.valueOf(readColorFromAttributes(context, a, C0593R.styleable.Badge_badgeTextColor));
            }
        } else {
            state.badgeTextColor = storedState.badgeTextColor;
        }
        if (storedState.badgeGravity == null) {
            intValue2 = a.getInt(C0593R.styleable.Badge_badgeGravity, 8388661);
        } else {
        ...
        if (storedState.horizontalOffsetWithoutText == null) {
            intValue3 = a.getDimensionPixelOffset(C0593R.styleable.Badge_horizontalOffset, 0);
        } else {
            intValue3 = storedState.horizontalOffsetWithoutText.intValue();
        }
        state.horizontalOffsetWithoutText = Integer.valueOf(intValue3);
        if (storedState.horizontalOffsetWithoutText == null) {
            intValue4 = a.getDimensionPixelOffset(C0593R.styleable.Badge_verticalOffset, 0);
        } else {
        ...
        if (storedState.horizontalOffsetWithText == null) {
            intValue5 = a.getDimensionPixelOffset(C0593R.styleable.Badge_horizontalOffsetWithText, state.horizontalOffsetWithoutText.intValue());
        } else {
        ...
        if (storedState.verticalOffsetWithText == null) {
            intValue6 = a.getDimensionPixelOffset(C0593R.styleable.Badge_verticalOffsetWithText, state.verticalOffsetWithoutText.intValue());
        } else {
    ...
    private TypedArray generateTypedArray(Context context, int badgeResId, int defStyleAttr, int defStyleRes) {
        ...
        return ThemeEnforcement.obtainStyledAttributes(context, attrs, C0593R.styleable.Badge, defStyleAttr, style, new int[0]);
    }
