...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C0593R.attr.snackbarButtonStyle};
    private static final int[] SNACKBAR_CONTENT_STYLE_ATTRS = {C0593R.attr.snackbarButtonStyle, C0593R.attr.snackbarTextViewStyle};
    ...
    private static Snackbar makeInternal(Context context, View view, CharSequence text, int duration) {
        ...
        if (hasSnackbarContentStyleAttrs(context)) {
            i = C0593R.layout.mtrl_layout_snackbar_include;
        } else {
            i = C0593R.layout.design_layout_snackbar_include;
        }
