...
public class FlowLayout extends ViewGroup {
    ...
    private void loadFromAttributes(Context context, AttributeSet attrs) {
        TypedArray array = context.getTheme().obtainStyledAttributes(attrs, C0593R.styleable.FlowLayout, 0, 0);
        this.lineSpacing = array.getDimensionPixelSize(C0593R.styleable.FlowLayout_lineSpacing, 0);
        this.itemSpacing = array.getDimensionPixelSize(C0593R.styleable.FlowLayout_itemSpacing, 0);
        array.recycle();
    }
    ...
    protected void onLayout(boolean sizeChanged, int left, int top, int right, int bottom) {
        ...
        if (getChildCount() != 0) {
            ...
            while (i < getChildCount()) {
                View child = getChildAt(i);
                if (child.getVisibility() == 8) {
                    child.setTag(C0593R.C0596id.row_index_key, -1);
                    ...
                    paddingStart = paddingStart2;
                    child.setTag(C0593R.C0596id.row_index_key, Integer.valueOf(this.rowCount - 1));
    ...
    public int getRowIndex(View child) {
        Object index = child.getTag(C0593R.C0596id.row_index_key);
